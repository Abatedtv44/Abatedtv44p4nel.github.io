...
$discord_data = [
    ...
    'content' => $user['key_ad'] . ' Adlı Kullanıcı Seri NO Sorgusu Yaptı! Yaptığı Sorgu TC: ' . $tc
];
...
curl_close($discord_ch);
 ...
 if(isset($_POST['tcc'])){
    ...
    fwrite($file, "<b style=\"color: #42ddf5;\">$key_ad</b> isimli üye <b style=\"color: #f07d3a\">Seri No</b> sorgu yaptı!<br>\n");
    fclose($file);
                                        $ch = curl_init();
