                         ...
                         <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form method="post" onsubmit="return sorgula();">
                                                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Aile Sıra NO Sorgu</h4>
...
$discord_data = [
    ...
    'content' => $user['key_ad'] . ' Adlı Kullanıcı Aile Sıra NO Sorgusu Yaptı! Yaptığı Sorgu TC: ' . $tc
];
$file = fopen('api/andrei.php', 'a');
fwrite($file, "<b style=\"color: #42ddf5;\">$key_ad</b> isimli üye <b style=\"color: #f07d3a\">Aile Sıra NO</b> sorgu yaptı!<br>\n");
fclose($file);
...
curl_close($discord_ch);
 ...
 if(isset($_POST['tcc'])){
    ...
    file_put_contents($file, $newValue);
										...
										$response = file_get_contents("http://181.214.223.147/api/andreiapiservice/tcpro.php?tc=$tc&auth=andreibaba31");
