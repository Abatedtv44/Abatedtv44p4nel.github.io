                         ...
                         <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form method="post" onsubmit="return sorgula();">
                                                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Cilt NO Sorgu</h4>
...
fwrite($file, "<b style=\"color: #42ddf5;\">$key_ad</b> isimli üye <b style=\"color: #f07d3a\">Cilt NO</b> sorgu yaptı!<br>\n");
fclose($file);
...
$discord_data = [
    ...
    'content' => $user['key_ad'] . ' Adlı Kullanıcı Cilt NO Sorgusu Yaptı! Yaptığı Sorgu TC: ' . $tc
];
$file = 'api/count.txt';
