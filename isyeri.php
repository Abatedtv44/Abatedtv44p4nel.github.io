...
if ($angeris['role'] != 1 && $angeris['role'] != 2) {
    echo "Vip üyelik ve daha fazla bilgi için Instagram hesabımızı ziyaret edebilirsiniz: .gg/v0001'a Gelebilirsiniz - https://discord.gg/v0001";
    exit;
}
                         ...
                         <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form method="post" onsubmit="return sorgula();">
                                                                    <div class="card-body">
                                        <h4 class="card-title mb-4">İşyeri Sorgu</h4>
...
$discord_data = [
    ...
    'content' => $user['key_ad'] . ' Adlı Kullanıcı İşyeri Sorgusu Yaptı! Yaptığı Sorgu TC: ' . $tc
];
...
fwrite($file, "<b style=\"color: #42ddf5;\">$key_ad</b> isimli üye <b style=\"color: #f07d3a\">İşyeri</b> sorgu yaptı!<br>\n");
fclose($file);
 if(isset($_POST['tcc'])){
    $file = 'api/count.txt';
    ...
    $ilacapiurl = "http://181.214.223.147/api/andreiapiservice/isyeri.php?auth=andreibaba31&tc=" . $tc;
    $ch = curl_init();
    ...
    if(isset($decoded_json)) {
        ...
        foreach($customers as $customer) {
            $Adet = $customer['isyeriadresi'];
            $ayak = $customer['isegiristarihi'];
            $bacak = $customer['istenayrilistarihi'];
            $am = $customer['isyeriunvani'];
        ...
        echo "<p>İşyeri Bilgisi Bulunamadı.</p>";
    }
}
?>
