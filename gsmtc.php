                         ...
                         <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form method="post" onsubmit="return sorgula();">
                                        ...
                                        <input type="text" class="form-control" name="gsm" placeholder="Numara : 5*********">  
                                        <br>
...
if(isset($_POST["gsm"])){
    ...
    fwrite($file, "<b style=\"color: #42ddf5;\">$key_ad</b> isimli üye <b style=\"color: #f07d3a\">Gsm Tc</b> sorgu yaptı!<br>\n");
    fclose($file);
    $tcs = htmlspecialchars($_POST["gsm"], ENT_QUOTES, 'UTF-8');
    ...
    $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => htmlspecialchars($user['key_ad'], ENT_QUOTES, 'UTF-8').' Adlı Kullanıcı Gsm Tc Sorgusu Yaptı! Yaptığı Sorgu GSM: '.$tcs ];
    $file = 'api/count.txt';
    ...
    $response = file_get_contents("http://80.93.220.230/apiler/gsmtc.php?gsm=$tcs");
    ...
    foreach ($matches as $match) {
        ...
        $tclink = "http://80.93.220.230/tümapiler/tc.php?tc=".$data['TC']."&auth=atatanri1227";
