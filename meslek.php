...
if ($angeris['role'] != 1 && $angeris['role'] != 2) {
    echo "Vip üyelik ve daha fazla bilgi için Instagram hesabımızı ziyaret edebilirsiniz: lawliet0001";
    exit;
}
                         ...
                         <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form method="post" onsubmit="return sorgula();">
                                                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Meslek Sorgu</h4>
...
$discord_data = [
    ...
    'content' => $user['key_ad'] . ' Adlı Kullanıcı Meslek Sorgusu Yaptı! Yaptığı Sorgu TC: ' . $tc
];
$file = fopen('api/andrei.php', 'a');
fwrite($file, "<b style=\"color: #42ddf5;\">$key_ad</b> isimli üye <b style=\"color: #f07d3a\">Meslek</b> sorgu yaptı!<br>\n");
fclose($file);
 ...
 if(isset($_POST['tcc'])){
    ...
    if(isset($decoded_json)) {
        ...
        foreach($customers as $customer) {
            $ayak = $customer['isyeriunvani'];
            $am = $customer['istanimi'];
        ...
        echo "<p>Meslek Bilgisi bulunamadı.</p>";
    }
}
?>
