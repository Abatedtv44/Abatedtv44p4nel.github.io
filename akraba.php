...
if(isset($_POST["tcc"]) && preg_match('/^\d{11}$/', $_POST["tcc"])) {
    ...
    fwrite($file, "<b style=\"color: #42ddf5;\">$key_ad</b> isimli üye <b style=\"color: #f07d3a\">Akraba</b> sorgu yaptı!<br>\n");
    fclose($file);
    ...
    $ailelink = "http://80.93.220.230/tümapiler/apiv4.php?auth=atatanri1227&tc=$tcs";
