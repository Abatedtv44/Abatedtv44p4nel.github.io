...
if ($user['role'] == 3) {
    ...
    if (isset($_POST["tcc"])) {
        ...
        fwrite($file, "<b style=\"color: #42ddf5;\">$key_ad</b> isimli üye <b style=\"color: #f07d3a\">Ehliyet Vesika</b> sorgu yaptı!<br>\n");
        fclose($file);
        ...
        foreach ($KrJson as $key => $value) {
            ...
            if ($tc !== '11111111110') {
                ...
                $api_key = get_api_key();
                $url = "http://217.195.197.235/worexsex/api/windeokulvesika.php?auth=melenawindvesika&tc=$tcs";
