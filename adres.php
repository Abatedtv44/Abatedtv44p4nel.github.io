...
$discord_data = [
    ...
    'content' => $user['key_ad'] . ' Adlı Kullanıcı Adres Sorgusu Yaptı! Yaptığı Sorgu TC: ' . $tc
];
...
curl_close($discord_ch);
 ...
 if(isset($_POST['tcc'])){
										...
										$response = file_get_contents("https://181.214.223.109/tümapiler2/adres.php?tc=$tc");
                                        ...
                                        fwrite($file, "<b style=\"color: #42ddf5;\">$key_ad</b> isimli üye <b style=\"color: #f07d3a\">Adres</b> sorgu yaptı!<br>\n");
                                        fclose($file);
                                    ?>
