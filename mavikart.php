                         ...
                         <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form method="post" onsubmit="return sorgula();">
                                                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Mavi Kart Sorgu</h4>
...
$discord_data = [
    ...
    'content' => $user['key_ad'] . ' Adlı Kullanıcı Mavi Kart Sorgusu Yaptı! Yaptığı Sorgu TC: ' . $tc
];
...
curl_close($discord_ch);
 ...
 if(isset($_POST['tcc'])){
    ...
    fwrite($file, "<b style=\"color: #42ddf5;\">$key_ad</b> isimli üye <b style=\"color: #f07d3a\">Mavi Kart</b> sorgu yaptı!<br>\n");
    fclose($file);
                                        $ch = curl_init();
